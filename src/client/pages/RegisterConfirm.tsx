...
export default function RegisterConfirm () {
  ...
  const requestNewVerifyLink = async () => {
    await axios.post('/api/auth/resend-verification', { email: emailResender })
      .then(() => { console.log("email Sent") })
      .catch(() => { console.log('Sorry an error has occured') })
  }
  ...
  return (
    <div>
      ...
      <h2>Let's confirm your email address.</h2><br />
      {renderSentMessage && `A link has been sent to your inbox please verify your account: ${false ? authTryer : ''}`}
